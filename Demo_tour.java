...
public class Demo_tour {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\Asus\\Desktop\\Selenium_jar\\chromedriver.exe");
		...
		// choose image
		w.findElement(By.id("uploadfile_0")).sendKeys("C:\\Users\\Dell\\Pictures\\15.jpg");
		...
		w.findElement(By.id("user_firstname")).sendKeys("Aarti");

		w.findElement(By.id("user_surname")).sendKeys("Shinde");

		w.findElement(By.id("user_phone")).sendKeys("9087654321");
		...
		w.findElement(By.id("user_address_attributes_street")).sendKeys("Ambegoan- bk");
		...
		w.findElement(By.id("user_address_attributes_postcode")).sendKeys("411046");

		w.findElement(By.id("user_user_detail_attributes_email")).sendKeys("aartishinde@gmail.com");

		w.findElement(By.id("user_user_detail_attributes_password")).sendKeys("1234");

		w.findElement(By.id("user_user_detail_attributes_password_confirmation")).sendKeys("1234");

		w.findElement(By.name("submit")).click();

		Thread.sleep(2000);

		w.findElement(By.name("email")).sendKeys("aartishinde@gmail.com");
		...
		w.findElement(By.name("name")).sendKeys("Aarti");
		w.findElement(By.name("emailid")).sendKeys("aartishinde@gmail.com");
		w.findElement(By.name("telephoneno")).sendKeys("9087654321");
		w.findElement(By.name("addr")).sendKeys("Hello");
		w.findElement(By.id("fileToUpload")).sendKeys("C:\\Users\\Dell\\Pictures\\1.jpg");
		Thread.sleep(2000);
		...
		w.findElement(By.id("fname")).sendKeys("A");
		w.findElement(By.id("lname")).sendKeys("S");
		w.findElement(By.id("email")).sendKeys("as@gmail.com");
		w.findElement(By.xpath("//textarea[@id='message']")).sendKeys("Pune");
		w.findElement(By.id("telephoneno")).sendKeys("9087654321");
		w.findElement(By.name("submit")).click();
		Thread.sleep(3000);
		...
		w.findElement(By.linkText("REGISTER")).click();
		w.findElement(By.name("firstName")).sendKeys("Aarti");
		w.findElement(By.name("lastName")).sendKeys("Shinde");
		w.findElement(By.name("phone")).sendKeys("1234567890");
		w.findElement(By.name("userName")).sendKeys("aartishnde@gmail.com");
		w.findElement(By.name("address1")).sendKeys("Ambegoan");
		w.findElement(By.name("city")).sendKeys("Pune");
		w.findElement(By.name("state")).sendKeys("Maharashtra");
		w.findElement(By.name("postalCode")).sendKeys("411046");
		Select se = new Select(w.findElement(By.name("country"))); // dropdown
		se.selectByValue("INDIA"); // drop down choice selection
		w.findElement(By.name("email")).sendKeys("aartishinde");
		w.findElement(By.name("password")).sendKeys("aarti");
		w.findElement(By.name("confirmPassword")).sendKeys("aarti");
		Thread.sleep(2000);
		w.findElement(By.name("submit")).click();
		w.findElement(By.linkText("Home")).click();
